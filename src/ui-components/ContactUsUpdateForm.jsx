...
import { getContactUs } from "../graphql/queries";
import { updateContactUs } from "../graphql/mutations";
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getContactUs.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getContactUs
        : contactUsModelProp;
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateContactUs.replaceAll("__typename", ""),
            variables: {
              input: {
                id: contactUsRecord.id,
                ...modelFields,
              },
            },
          });
